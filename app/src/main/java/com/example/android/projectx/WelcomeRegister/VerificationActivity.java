...
public class VerificationActivity extends AppCompatActivity  implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String phoneNumberFromResgisterActivity = getIntent().getStringExtra("phoneNumber");
        mPhoneNumberField.setText(phoneNumberFromResgisterActivity);
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        ...
        if (user == null) {
            ...
            */
            ...
            editor.putString("phoneNumber", mPhoneNumberField.getText().toString());
            editor.commit();
